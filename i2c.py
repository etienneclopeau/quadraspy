# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 09:42:50 2013

@author: clopeau
"""

#ce test permet de lancer le code sur un odinateur sans smbus
#donc pas d'acces a i2c
try :
    import smbus
    bus = smbus.SMBus(1)
except:
    print 'Warning: smbus not availabe'
    class noSmbus():
        def __init__(self):
            pass
...
class i2c:
    def __init__(self, address, bus = bus):
...
#        return output        
    ...
    def readList(self, reg, length):
        ...
        try:
            ...
            print ("Error readlist at 0x%02X: Check your I2C address" % self.address)
        return -1
