...
def update():
    ...
    dataGyrx.append(np.degrees(gyrx))
    dataGyry.append(np.degrees(gyry))
    dataGyrz.append(np.degrees(gyrz))
    dataGyrbx.append(gyr_ba[0])
    dataGyrby.append(gyr_ba[1])
    dataGyrbz.append(gyr_ba[2])
    dataPsi.append(np.degrees(psi))
    dataTheta.append(np.degrees(theta))
    dataPhi.append(np.degrees(phi))
